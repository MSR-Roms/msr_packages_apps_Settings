...
public class LockscreenStyle extends SettingsFragment implements
    ...
    private static final int LOCK_STYLE_ACER = 5;
    private static final int LOCK_STYLE_HONEY = 6;
    private static final int LOCK_STYLE_SENSE = 7;
        ...
        if (preference == mLockscreenStyle) {
            ...
            switch (value) {
                ...
                case LOCK_STYLE_ACER:
                    if (!getResources().getBoolean(R.bool.config_acer_lock_enabled)) {
                        return true;
                    }
                case LOCK_STYLE_SENSE:
                    if (!getResources().getBoolean(R.bool.config_sense_lock_enabled)) {
                        return true;
                    }
                case LOCK_STYLE_GB:
                default:
